...
const News = () => {
	...
	<div className="flex space-x-4">
		<img alt="" src="https://source.unsplash.com/100x100/?portrait" className="object-cover rounded-full shadow dark:bg-gray-500" />
	...
	<div>
		...
		<h2 className="mb-1 text-xl font-semibold">Hello</h2>
